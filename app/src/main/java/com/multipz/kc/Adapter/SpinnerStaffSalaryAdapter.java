...
public class SpinnerStaffSalaryAdapter extends BaseAdapter {

    Context c;

    ArrayList<SpinnerModel> objects;

    public SpinnerStaffSalaryAdapter(Context context, ArrayList<SpinnerModel> objects) {
        super();
        this.c = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.spinnerstaffattendence, parent, false);
