...
public class SiteExReportAdapter extends BaseAdapter {
    ...
    public SiteExReportAdapter(Context context, ArrayList<SiteExReportModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            holder = new Holder();
            rowView = inflater.inflate(R.layout.site_report_item, parent, false);
